...
public class FeignSpringFormEncoder implements Encoder {
    ...
    public void encode(Object object, Type bodyType, RequestTemplate template) throws EncodeException {
        if (isFormRequest(bodyType)) {
            ...
            multipartMap.put("file", file);
            multipartMap.put("content", file);
            encodeMultipartFormRequest(multipartMap, template);
        } else {
            encodeRequest(object, jsonHeaders, template);
        }
    }

    public void encodeMultipartFormRequest(Map<String, ?> formMap, RequestTemplate template) throws EncodeException {
        if (formMap == null) {
    ...
    public boolean isMultipartFile(Object object) {
        return object instanceof MultipartFile;
    }

    public boolean isMultipartFileArray(Object o) {
        return o != null && o.getClass().isArray()
                && MultipartFile.class.isAssignableFrom(o.getClass().getComponentType());
    }

    public HttpEntity<?> encodeMultipartFile(MultipartFile file) {
    ...
    public void encodeMultipartFiles(LinkedMultiValueMap<String, Object> map, String name,
    ...
    public HttpEntity<?> encodeJsonObject(Object o) {
    ...
    @SuppressWarnings("unchecked")
    public void encodeRequest(Object value, HttpHeaders requestHeaders, RequestTemplate template)
